...
abstract: |
  ...
  introduction to using mrgsolve in a single document. Be sure to visit
  [https://mrgsolve.org](mrgsolve.org) for additional resources to help you 
  learn and effectively use mrgsolve. 
...
We suggest writing the model in small sections, iteratively checking to see if 
